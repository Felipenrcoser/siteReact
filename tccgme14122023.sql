...
CREATE TABLE `empresa` (
  `id` int(11) NOT NULL,
  `desc_empresa` varchar(60) DEFAULT NULL,
...
INSERT INTO `empresa` VALUES (0,'Uma Grande Empresa S.A','2023-12-01','2023-12-01'),(1,'ADS UCEFF 2023',NULL,NULL),(2,'Uma pequena Empresa S.A','2023-12-01','2023-12-01');
...
CREATE TABLE `estoque` (
  ...
  CONSTRAINT `estoque_ibfk_1` FOREIGN KEY (`idEmpresaREf`) REFERENCES `empresa` (`id`),
...
INSERT INTO `estoque` VALUES (1,6,9),(1,12,11),(1,18,13),(1,24,6),(1,30,9),(1,36,14),(1,42,13),(1,48,15),(1,54,8),(1,60,1),(1,66,14),(1,72,9);
...
CREATE TABLE `produto` (
  ...
  CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`idEmpresaREf`) REFERENCES `empresa` (`id`),
...
CREATE TABLE `quantidadedesejada` (
  ...
  KEY `idEmpresaREf` (`idEmpresaREf`),
  KEY `idProdutoRef` (`idProdutoRef`),
  CONSTRAINT `quantidadedesejada_ibfk_1` FOREIGN KEY (`idEmpresaREf`) REFERENCES `empresa` (`id`),
...
INSERT INTO `sequelizemeta` VALUES ('20231201182059-tccgme.js'),('20231201200700-empresa.js'),('20231201205730-empresa1.js');
...
CREATE TABLE `usuarioporempresa` (
  ...
  CONSTRAINT `usuarioporempresa_ibfk_2` FOREIGN KEY (`idEmpresaREf`) REFERENCES `empresa` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-12-14 20:04:33
